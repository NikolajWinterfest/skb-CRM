...
Реализована CRM система с база контактных данных клиентов со следующими возможностями:

-   Адаптивная вёрстка до мобильной версии 320px
-   Создание клиента с добавлением его данных (email, номер телефона, социальные сети и др.)
-   Максимальное количество контактных данных клиента для связи - 10
-   Есть возможность изменить контактные данные клиента, а также удалить самого клиента из базы данных
